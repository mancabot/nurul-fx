...
break
        ...
        if (chats == '#menu'){
         client.sendPtt(from, './assets/onichan.mp3', id)
        }
        }
        if (chats == '!menu'){
         client.sendPtt(from, './assets/onichan.mp3', id)
        ...
        if (chats == 'tolol'){
         client.sendPtt(from, './assets/tolol.mp3', id)
        }
        }
        if (chats == 'tidur woi'){
         client.sendPtt(from, './assets/tidurwoi.mp3', id)
        }
        }
        if (chats == 'wayae'){
         client.sendPtt(from, './assets/wayae.mp3', id)
        }
        }
        if (chats == 'Hmm'){
         client.sendPtt(from, './assets/Naon.mp3', id)
        }
        }
        if (chats == '#owner'){
         client.sendPtt(from, './assets/owner.mp3', id)
        }
        }
        if (chats == '!owner'){
         client.sendPtt(from, './assets/owner.mp3', id)
        ...
        if (chats == 'bernyanyi'){
         client.sendPtt(from, './assets/bernyanyi.mp3', id)
        }
        }
        if (chats == 'nyanyi'){
         client.sendPtt(from, './assets/bernyanyi.mp3', id)
